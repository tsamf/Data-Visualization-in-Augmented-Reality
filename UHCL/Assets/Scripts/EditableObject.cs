...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public class EditableObject : MonoBehaviour, IFocusable, IInputHandler, ISourceStateHandler
    {
        /// <summary>
        ...
        void RemoveAnchor()
        {
            ...
            if (this.store.Load(this.gameObject.name,this.gameObject) != null)
            {
                ...
                store.Delete(this.gameObject.name);
            }
        }
        ...
        void AddAnchor()
        {
            ...
            if (this.store.Load(this.gameObject.name, this.gameObject) == null)
            {
                ...
                this.store.Save(this.gameObject.name, worldAnchor);
            }
        }
