...
public class BL_Tasks {
    ...
    void AwakeFunction()
    {
        ...
        task23.warning = "";
        task23.holograms = "E-Stop";
        task23.images = "";
        UITask task24 = new UITask();
        task24.stepNumber = 24;
        task24.text = "Reistall it into the FUSIBLE DISCONNECT BOX";
        task24.warning = "";
        ...
        )
    {
        if(nextStep == true)
        {
            ...
            //if(commonData.currentTask.stepNumber == 28)
            //{
            //    previousTask = new UITask();
            //    currentTask.text = "Task Complete!";
            //    nextTask = new UITask();
            //} else
            //{
            //    int index = commonData.currentTask.stepNumber;
            //    commonData.previousTask = procedure.tasks[index - 1];
            //    commonData.currentTask = procedure.tasks[index];

            //    commonData.nextTask = procedure.tasks[index + 1];
